...
<body>
		...
		<div class="agileits_w3layouts_banner_nav">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> Pushpadhana</a></h1>
	...
	<div class="about-bottom">
		<div class="col-md-6 w3l_about_bottom_left">
			<div class="video-grid-single-page-agileits">
				<!--	<div data-video="fve9nlvkt-4" id="video">--> <img src="images/ab.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="col-md-6 w3l_about_bottom_right one">
		<div class="abt-w3l">
			<div class="header-w3l">
				...
				<form action="setting/insert.php" method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="agileits-main"><i class="fa fa-calendar" aria-hidden="true"></i>
								<input class="date" id="datepicker" name="dob" type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="" />
							</li>
					...
					<div class="agile-submit">
						<button class="btn btn-primary btn-lg" type="submit" value="submit" name="add_addmission"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Submit</button>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p><p style="color:red;">General Rules and Regulation of the school <br/><br/>1. The school gate will be closed exactly at 8:00 am everyday.<br/>2. Irregular attendance, disobedience and undesirable conduct on the part of the students will be appropriately tackled with the co-operation of their guardians.<br/>3. All communication between the guardian and the school will be done through it.<br/>4. If a student has to go back home at the request of the parent/guardian due to any emergency situation at home, then the person who will come to collect the child must be identified by the parent/guardian over telephone.<br/>5. Mobile phones, i-bots are not allowed for all classes at school If found, confiscate. </p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="services-w3ls-row">
				<div class="col-xs-4 services-grid agileits-w3layouts">
					...
					<p>Pushpadhana school will allows 25% discount on term fees for the 2nd and 3rd child of a family enrolling in any grade.</p>
				</div>
				<div class="col-xs-4 services-grid agileits-w3layouts">
					<h6>02</h6>
					<h5>Skilled Teachers</h5>
					<p>We provide well educated staff.</p>
				...
				<div class="col-xs-4 services-grid agileits-w3layouts">
					...
					<h6>03</h6>
					<h5>Book Library</h5>
					<p>The main computerized and air conditioned library, more than 15,000 text and other books, multiple copies of past question papers prepared subjectwise, useful magazines and other reading material.</p>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
	...
	<section class="portfolio-w3ls" id="gallery">
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/a3.jpg" class="swipebox"><img src="images/a3.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/20190902_112233.jpg" class="swipebox"><img src="images/20190902_112233.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/20190902_113021.jpg" class="swipebox"><img src="images/20190902_113021.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/a.jpg" class="swipebox"><img src="images/a.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/a5.jpg" class="swipebox"><img src="images/a5.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/a7.jpg" class="swipebox"><img src="images/a7.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/a6.jpg" class="swipebox"><img src="images/a6.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/dc.jpg" class="swipebox"><img src="images/dc.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/a1.jpg" class="swipebox"><img src="images/a1.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
		...
		<div class="col-md-3 col-xs-3 gallery-grid gallery1">
			<a href="images/a2.jpg" class="swipebox"><img src="images/a2.jpg" class="img-responsive" alt="/">
				<div class="textbox">
					<h4>scholarly</h4>
					<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
				</div>
	...
	<div class="team-w3l" id="team">
		<div class="container">
			<h3 class="w3l-title">Our Skilled Teachers</h3>
			<div class="w3layouts_header">
				<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
			</div>
		...
		<div id="mail" class="contact">
			<div class="container">
				...
				<div class="agile_banner_bottom_grids">
					...
					<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
						...
						<div class="agile_contact_grid_right agileits_w3layouts_right1">
							<h4>Email</h4>
							<p><a href=""><?php echo "sajidhamuzammil@gmail.com"; ?></a></p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="clearfix"> </div>
				...
				<div class="w3l-form">
					...
					<div class="contact-grid1" style="background:black;">
						<div class="contact-top1">
							<form action="setting/insert1.php" method="post">
								...
								<input type="submit" value="Send" onclick="thisFunction()">
							</form>
			...
			<div class="container">
				<div class="wthree_footer_grid_left">
					<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
						<h4>About Us</h4>
						<p><?php echo "46 years of experience"; ?></p>
					</div>
					<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
						<h4>Navigation</h4>
						<ul>
					...
					<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
						<h4>Contact Us</h4>
						<ul>
							<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href=""><?php echo "sajidhamuzammil@gmail.com"; ?></a></li>
							<li><i class="fa fa-phone" aria-hidden="true"></i><?php echo "+94766062424" ?></li>
							<li><i class="fa fa-fax" aria-hidden="true"></i><?php echo "Kegalla" ?></li>
						</ul>
					</div>
					<div class="clearfix"> </div>
				</div>
