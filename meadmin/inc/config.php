...

{
	...
	{
		$add_student_insert = "insert into st_info(st_fullname,st_username,st_password,st_grade,st_grade,roll_no,st_dob,st_address,st_district,st_gender,st_father,st_mother,st_parents_contact) value('$std_fullname','$std_username','$std_password','$std_grade','$std_roll','$std_dob','$std_address','$std_district','$std_gender','$std_father','$std_mother','$std_parent_contact')";
	...
	public function update_st_info($up_fullname, $up_grade, $up_section, $up_roll_no, $up_dob, $up_address, $up_district, $up_gender, $up_father, $up_mother, $up_contact)
	{
